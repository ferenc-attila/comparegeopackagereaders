...
class ReadGeoPackageByGeoToolsTest {
    ...
    void getPointFeaturesTest() {
        List<Location> result = readGeoPackageByGeoTools.getAllFeatures("ne_10m_populated_places", "NAME", "POP_MAX");
        ...
        assertEquals(26013, result.get(500).getPopulation());
    ...
    void getLineFeaturesTest() {
        List<Location> result = readGeoPackageByGeoTools.getAllFeatures("ne_10m_roads", "type", "length_km");
        ...
        assertEquals(73, result.get(500).getPopulation());
        assertEquals(4326, result.get(2).getSrsId());
    ...
    void getPolygonFeaturesTest() {
        List<Location> result = readGeoPackageByGeoTools.getAllFeatures("ne_10m_countries", "NAME_LONG", "POP_EST");
